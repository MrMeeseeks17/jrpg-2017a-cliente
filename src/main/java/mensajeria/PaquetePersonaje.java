...
public class PaquetePersonaje extends Paquete implements Serializable, Cloneable {
	...
	public final void anadirItem(int idItem, String nombre, int bonusSalud, int bonusEnergia, int bonusAtaque, int bonusDefensa, int bonusMagia, String foto) {
		try {
			items.add(new Item(idItem,nombre,bonusSalud,bonusEnergia,bonusAtaque, bonusDefensa, bonusMagia, foto));
